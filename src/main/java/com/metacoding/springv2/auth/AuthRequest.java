...
public class AuthRequest {
     ...
     * "유저네임은 4자 이상 20자 이하로 입력해주세요") @NotEmpty(message = "유저네임을 입력해주세요") String
     * username,
     * 
     * @NotBlank(message = "비밀번호를 입력해주세요") @Size(min = 4, max = 12, message =
     * "비밀번호는 4~12자여야 합니다") String password,
     * 
